...
#MFA_DEVICE_ARN=arn:aws:iam::857382126539:user/kukinwidgas
MFA_SERIAL=arn:aws:iam::857382126539:mfa/iPhone
PATH_TO_CREDENTIALS_FILE=~/.aws/credentials
...
COMMAND="aws --output json sts get-session-token \
